...
class Callback:
    ...
    def on_predict_batch_start(self, trainer: Any, model: Any, batch: Any, batch_idx: int = 0) -> None: ...
    def on_predict_batch_end(self, trainer: Any, model: Any, outputs: Any, batch: Any, batch_idx: int = 0) -> None: ...
